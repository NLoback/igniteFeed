    ...
    return (
        <aside className={styles.sidebar}>
            ...
            <div className={styles.profile}>
               <Avatar hasBorder src="https://pps.whatsapp.net/v/t61.24694-24/223253605_1553468925076275_3801217370321793839_n.jpg?ccb=11-4&oh=01_AdSnpyUxXV2asF46jPVKoSZE0wMOH_ClHZQd8BPGB9Qy6w&oe=6465379E"/>
